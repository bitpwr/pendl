...
describe('getActiveServiceIds', () => {
  ...
  it('should return weekday service on a Tuesday', () => {
    ...
    const result = getActiveServiceIds(date, [baseCalendar, weekendCalendar], []);
  ...
  it('should handle exception additions', () => {
    ...
    const result = getActiveServiceIds(date, [baseCalendar, weekendCalendar], calendarDates);
  ...
  it('should not include services outside date range', () => {
    ...
    const date = new Date('2026-01-27');
    const result = getActiveServiceIds(date, [baseCalendar, expiredCalendar], []);
