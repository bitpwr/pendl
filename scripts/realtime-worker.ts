...
async function runWorker(): Promise<void> {
  ...
  console.log(`Trip updates URL: ${GTFS_CONFIG.realtimeUrls.tripUpdates || 'not configured'}`);
  console.log(`Vehicle positions URL: ${GTFS_CONFIG.realtimeUrls.vehiclePositions || 'not configured'}`);
  console.log(`Service alerts URL: ${GTFS_CONFIG.realtimeUrls.serviceAlerts || 'not configured'}`);
  console.log('');
